...
Navigation and routing entry point for this context architecture. Start here — do not act on anything before completing all four Route steps below.

> **New instance setup:** If you are forking or copying this template, replace this document purpose with a description of your specific initiative. Update the routing table in Step 2 with your project and domain names. Rename the repo. See `Architecture.md` for the full structural guide.
...
- **Do not update this README silently.** After any structural change, propose the update and wait for approval.
...
→ Add a routing row in README.md Step 2
...
```
[repo-name]/                          ← repo root (rename to match your initiative)
  README.md                           ← This file — routing entry point
  Architecture.md                     ← System design reference
  MarkdownConventions.md              ← Markdown standards for all files
  .github/
    copilot-instructions.md           ← VS Code entry point — loads README

  knowledge/                          ← All cross-project knowledge and protocol
    flow/                             ← How knowledge moves and gets applied
